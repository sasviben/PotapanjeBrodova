...
{
    [TestClass]
    public class TestSustavnogPucaca
    {
        [TestMethod]
        public void SustravniPucač_UputiPucanjVraćaLijevoIliDesnoPoljeZaHorizontalniSmjer()
        {
            List<Polje> pogođenaPolja = new List<Polje> {new Polje(3, 3), new Polje(3, 2) };
        ...
        [TestMethod]
        public void SustravniPucač_UputiPucanjVraćaGornjeIliDonjePoljeZaVertikalniSmjer()
        {
        ...
        [TestMethod]
        public void SustravniPucač_UputiPucanjVraćaDonjePoljeZaVertikalniSmjerUzRubMreže()
        {
        ...
        [TestMethod]
        public void SustravniPucač_UputiPucanjVraćaDesnoPoljeZaHorizontalniSmjerAkoJeLijevoPoljeVećEliminirano()
        {
